...
pub fn process_work_item(path: &Path, current_dirid: u64, parent_dirid: Option<u64>) -> DirResult {
    ...
    batch.dirs.push(DirRecord {
        ...
        mtime:     statx_time_to_datetime(&self_sx.stx_mtime),
    });
        ...
        match file_type {
            ...
            FileType::RegularFile => {
                batch.files.push(FileRecord {
                    ...
                    atime:          statx_time_to_datetime(&sx.stx_atime),
                    mtime:          statx_time_to_datetime(&sx.stx_mtime),
                    ctime:          statx_time_to_datetime(&sx.stx_ctime),
...
pub fn statx_time_to_datetime(t: &rustix::fs::StatxTimestamp) -> chrono::DateTime<chrono::Utc> {
    chrono::DateTime::from_timestamp(t.tv_sec, t.tv_nsec as u32)
        .unwrap_or_default()
}
